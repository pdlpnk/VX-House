import type { SystemMessageKey, TranslationValues } from "@/lib/i18n";
...
export type SupportMessageView = { id: string; authorType: "USER" | "OPERATOR" | "SYSTEM"; authorLabel: string; body: string; systemKey?: SystemMessageKey; systemParams?: TranslationValues; createdAt: string; attachments: { id: string; fileName: string; mediaType: string; sizeBytes: number }[] };
