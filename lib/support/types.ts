...
export type SupportMessageView = { id: string; authorType: "USER" | "OPERATOR" | "SYSTEM"; authorLabel: string; body: string; createdAt: string };
...
export type SupportConversationView = { id: string; category: SupportCategoryView; priority: SupportPriority; status: SupportStatus; subject: string; context: Record<string, unknown>; createdAt: string; updatedAt: string; messages: SupportMessageView[]; history: StatusHistoryView<SupportStatus>[]; appeals: AppealView[] };
