...
export default async function SupportTicketPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const { principal } = await requireProductWorkspaceContext("PLAYER", `/dashboard/support/${id}`); let ticket = null;
  ...
  return <SupportTicketDetail ticket={ticket} basePath="/dashboard/support" />;
}
